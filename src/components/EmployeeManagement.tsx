        ...
        <div className="glass-card" style={{ padding: 24, textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 30, flexWrap: 'wrap' }}>
            <div className="glass-card" style={{ padding: 16, width: 220 }}>
              ...
              <div style={{ fontWeight: 600 }}>นางสาว อำภา หิงคำ</div>
            ...
            <div className="glass-card" style={{ padding: 16, width: 220 }}>
              ...
              <div style={{ fontWeight: 600 }}>นาย วิชัย สมบูรณ์ดี</div>
              ...
              <div className="glass-card" style={{ padding: 10, background: 'rgba(255,255,255,0.03)' }}>
                <div style={{ fontSize: '0.8rem', fontWeight: 600 }}>นาย สุริยา มารานนท์</div>
            ...
            <div className="glass-card" style={{ padding: 16, width: 220 }}>
              ...
              <div style={{ fontWeight: 600 }}>น.ส. พิชญดา อึ้งพยัคฆ์เดช</div>
